...
#                translation_vector = -translation_vector
    ...
    def reprojection_errors(self, camera_rotations, camera_translations, feature_locations):
        ...
        for i in range(self.nimages):
            ...
            #print(reprojected)
            #print(self.image_feature_locations[i][indices])
            #print("------",reprojected-self.image_feature_locations[i][indices])
            #print("Length errors", len(np.ravel(errors)))

            #time.sleep(1000)
            #print("ERRORS = ", np.ravel(errors))
    ...
    def fit_errors(self, params):
        ...
        #print(self.reprojection_errors(camera_rotations, camera_translations, feature_locations))
    ...
    def bundle_adjustment(self, camera_rotations, camera_translations):
        ...
        #print("self = ", self.seed_feature_locations)
        print("seed_feature", len(self.seed_feature_locations))
        print("camera_rotations=\n", camera_rotations.flatten())
